...
//메소드
 public List<String> search(String keyword ){
	  ...
	  //빈 문자열이 쿼리스트링 파리미터로 넘어오면 -빈객체 리턴
	  if(keyword==null || keyword.equals("")){
		  return Collections.EMPTY_LIST;
	    }
	  //쿼리스트링 파라미터로 넘어온값으로 시작되는 키워드를 추출하여 클라이언트로 출력
...
%>
<%  request.setCharacterEncoding("utf-8");//현재 페이지에 맞게 문자셋 설정
        ...
        for(int i=0;i<keywordList.size();i++){
        	...
        	out.print(key);
        	if(i<keywordList.size()-1) out.print(",");
        }
%>
</body>
</html>